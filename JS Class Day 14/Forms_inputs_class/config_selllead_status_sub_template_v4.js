	...
	"10": {
		...
		"q1": {
			...
			"c": {
				...
				"sub": {
					"a": {
						"name": "Inspection details entered w/o all other pricing details",
						"sub": false
					},
					"b": {
						"name": "Inspection details entered with all other Pricing details",
						"sub": false
					}
				}
			},
		...
		"fields": {
			...
			"b-a-a": {
				"fields": [{
					...
					"db-field": "message",
					"type": "message",
					"message": "Please open evaluation,accessories,car image,car pricing sections"
				}],
				"next-status": ""
			},
			"b-a-b": {
			...
			"c-a": {
				"fields": [{
					...
					"db-field": "message",
					"type": "message",
					"message": "Please go to Car Pricing Section and update price details"
				}],
				"next-status": ""
			},
			"c-b": {
